...
namespace EmptySoul.TestQuest.TestQuestWithDialogSystem.Editor.Scripts.Utils.MeshCombiner
{
	[CustomEditor(typeof(TestQuestWithDialogSystem.Utils.Optimization.Environment.MeshCombiner))]
	public class MeshCombinerEditor : UnityEditor.Editor
	{
		public override void OnInspectorGUI()
		{
			TestQuestWithDialogSystem.Utils.Optimization.Environment.MeshCombiner meshCombiner = (TestQuestWithDialogSystem.Utils.Optimization.Environment.MeshCombiner)target;
			Mesh mesh = meshCombiner.GetComponent<MeshFilter>().sharedMesh;

			#region Script:
			GUI.enabled = false;
			EditorGUILayout.ObjectField("Script", MonoScript.FromMonoBehaviour((TestQuestWithDialogSystem.Utils.Optimization.Environment.MeshCombiner)target), typeof(TestQuestWithDialogSystem.Utils.Optimization.Environment.MeshCombiner), false);
			GUI.enabled = true;
			#endregion Script.
